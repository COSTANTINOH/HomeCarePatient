...
class _CallHistoryState extends State<CallHistory> {
  ...
  Future<dynamic> getdoctordata() async {
    ...
    String myApi = "http://192.168.43.117/homecare/api/get_doctor_phone.php";
  ...
  Future<dynamic> sendCallHistory(
    ...
    String myApi = "http://192.168.43.117/homecare/api/call_history.php/";
  ...
  Future<dynamic> getPatientPage(String phone) async {
    ...
    String myApi = "http://192.168.43.117/homecare/api/getcall.php";
    final response = await http.post(myApi, headers: {
      'Accept': 'application/json'
    }, body: {
      "patient_id": "$value",
